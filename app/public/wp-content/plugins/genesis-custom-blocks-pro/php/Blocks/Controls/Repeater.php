	...
	public function validate( $value, $echo ) {
		...
		if ( $echo && defined( 'WP_DEBUG' ) && WP_DEBUG ) {
			$value = sprintf(
				...
				__( '⚠️ Please use Genesis Custom Blocks\'s %1$srepeater functions%2$s to display repeater fields in your template.', 'genesis-custom-blocks-pro' ),
				'<a href="https://developer.wpengine.com/genesis-custom-blocks/docs/fields/repeater/">',
				'</a>'
			);
		}
