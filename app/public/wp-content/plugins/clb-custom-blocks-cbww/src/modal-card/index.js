    ...
    'clb-custom-blocks/modal-card',
    {
        ...
        attributes: {
             ...
             cardDesc: {
                type: 'string',
                source: 'text',
                selector: '.modal-card-desc-input',
             },
             content: {
                 type: 'array',
                 source: 'children',
        ...
        edit: props => {
            const { attributes: { imgID, imgURL, imgAlt, cardTitle, cardDesc, content, titleID }, className, isSelected, setAttributes } = props;

            const onChangeTitle = cardTitle => { setAttributes( { cardTitle } ) };
            const onChangeDesc = cardDesc => { setAttributes( { cardDesc } ) };
            ...
            return (
			 ...
			 <div className={ className }>
					...
					<MediaUploadCheck>
                       ...
                       <TextControl
                          className='modal-card-desc-input'
                              ...
                              />
                               ...
                               <h4 className="modal-body-header">Modal Body</h4>
                                 ...
                                 <div className="clb-modal-card-static">
                                     ...
                                     <div className="modal-card-desc-input">{cardDesc}</div>
        ...
        save: props => {
                    const { attributes: { imgID, imgURL, imgAlt, cardTitle, cardDesc, content, titleID } } = props;
