...
export default registerBlockType(
    'cgb/staffcollection',
    {
        title: __( 'Staff Collection', 'clb_staff_collection' ),
        description: __( 'Add a set of people cards to your content ', 'clb_staff_collection'),
        category: 'common',
	   icon: {
	        foreground: '#fff',
	        background: '#3883d6',
        ...
        keywords: [ __( 'card' ), __( 'person' ), __( 'staff' ) ],
        attributes: {
            columnNumber: {
                type: 'number',
                default: 2,
        ...
        edit: props => {
            ...
            return (
                 ...
                 <InspectorControls>
                   <PanelBody
                       title={ __( 'Staff Collection Settings', 'clb_staff_collection' ) }
                   >
                       <PanelRow>
                       <RangeControl
               ...
               { isSelected ? (
                    ...
                    <h4>Staff Collection</h4>
                    <InnerBlocks
                         allowedBlocks={['cgb/staff']}
                    />
                    </div>
        ...
        save: props => {
            ...
            return (
                 ...
                 <div className={ 'interactive-cardset staff-collection' + ' columns-' + columnNumber}  data-card-height={flippedCardHeight} >
                    <InnerBlocks.Content />
                </div>
